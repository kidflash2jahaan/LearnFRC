  ...
  return (
    <div className="relative mx-auto max-w-4xl px-4 pt-28 pb-24 sm:px-6 lg:px-8">
      ...
      <header className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
        ...
        {total > 0 && (
          <div className="aq-glass aq-rise aq-rise-3 flex shrink-0 items-center gap-4 rounded-2xl px-5 py-4">
            <div
              className="aq-badge grid h-11 w-11 place-items-center"
      ...
      {total === 0 ? (
        <Reveal className="mt-12">
          <div className="aq-card aq-reveal mx-auto max-w-xl px-6 py-16 text-center">
            <div
              className="aq-badge mx-auto grid h-16 w-16 place-items-center"
              style={{ "--a": "#2560e6" } as CSSProperties}
            >
              <BookmarkX className="h-8 w-8" />
            </div>
            <h2 className="aq-display mt-6 text-2xl font-bold tracking-tight">
              No bookmarks yet
            </h2>
