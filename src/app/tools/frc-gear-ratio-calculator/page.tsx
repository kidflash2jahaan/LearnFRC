    ...
    <main className="relative mx-auto max-w-6xl px-4 pb-20 pt-28 sm:px-6 lg:px-8 lg:pt-32">
      ...
      <section className="mt-14 max-w-3xl">
        ...
        <div className="mt-3 space-y-4 text-[15px] leading-relaxed text-foreground/75">
          ...
          <p>
            So the convention is to derate. Multiplying free speed by 80 to 85%
        ...
        <div className="mt-3 space-y-4 text-[15px] leading-relaxed text-foreground/75">
          ...
          <p>
            ...
            smooth and Colson wheels somewhere around 0.8 to 1.0 and nitrile or
            roughtop tread around 1.1 to 1.4 on FRC carpet, but that swings with
        ...
        <div className="mt-3 space-y-4 text-[15px] leading-relaxed text-foreground/75">
          ...
          <p>
            ...
            quarter turn, fine for an arm but hopeless for a shooter. And check
