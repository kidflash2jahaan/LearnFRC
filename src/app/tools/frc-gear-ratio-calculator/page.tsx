...
const FAQS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Free speed is exact kinematics: motor no-load RPM divided by the reduction, times the wheel circumference. It assumes the robot is pushing against nothing. Adjusted speed multiplies that by roughly 0.8 to 0.85 to allow for rolling resistance, gearbox drag and wheel scrub. That derate is a long-standing FRC design-calculator convention rather than a derivation, which is why this tool exposes it as an editable field instead of burying it.",
  },
  {
