...
export const metadata: Metadata = {
  ...
  description:
    "Free FRC deflection calculator. Enter beam type, material (6061-T6 aluminum or steel), cross-section, length, and load to get tip/center sag, bending stress, and a safety factor. Works for arms, elevators, and drivetrain rails. Beam-mechanics formulas, sourced material properties.",
