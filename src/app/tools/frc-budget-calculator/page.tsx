...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Estimate what your FRC season will cost: registration, robot, tools, and travel. The result is itemized and sponsor-ready.",
    ...
    <main className="relative mx-auto max-w-6xl px-4 pb-20 pt-28 sm:px-6 lg:px-8 lg:pt-32">
      <JsonLd
        data={{
          ...
          url: `${SITE}/tools/frc-budget-calculator`,
          description:
            "Free interactive FRC team budget calculator covering registration, robot, tools, and travel, itemized and sponsor-ready.",
